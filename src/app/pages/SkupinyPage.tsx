    ...
    <div className="bg-[#FAF8F4]">
      ...
      <section className="relative pt-36 pb-20 md:pt-44 md:pb-28 overflow-hidden">
        <div className="absolute inset-0">
          <img src="https://images.unsplash.com/photo-1603228254119-e6a4d095dc59?w=1920&h=600&fit=crop" alt="" className="w-full h-full object-cover" />
          ...
          >
            <div className="rounded-2xl overflow-hidden border border-[#E8E4DD]/50 bg-[#F4F1EC]">
              <div className="aspect-[2/1] md:aspect-[5/2] relative overflow-hidden">
                <img
                  src="https://images.unsplash.com/photo-1592906209472-a36b1f3782ef?w=1200&h=500&fit=crop"
                  alt="Praha"
